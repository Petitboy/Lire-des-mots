...
var les_trois_petits_cochons = ['un lit', 'un pyjama', 'un tapis', 'un cygne', 'un sac', 'une cabane', 'un chat', 'le rat', 'la lune', 'une tortue', 
'une flûte', 'il hurle', 'le loup', 'le lilas', 'le lapin', 'la poule', 'la porte', 'le panier', 'la pomme', 'le chapeau'];
var la_petit_chaperon_rouge = ['la grand-mère', 'la malle', 'le mur', 'le chemin', 'une souris', 'le hibou', 'la mouche', 'une fourmi', 'le renard', 
'marron', 'le bûcheron', 'une fleur', 'les radis', 'des dents', 'midi', 'une salade', 'le chaperon', 'un cheval', 'un feu', 'des oeufs'];
var la_petite_poule_rousse =['le blé', 'un nez', 'le potager', 'du chocolat', 'la vache', 'le mouchoir', 'une chaise', 'la farine', 'le téléphone', 
'le foulard', 'le fauteuil', 'la photo', 'du savon', 'le citron', 'la tasse', 'la scie', 'un glaçon'];
var les_musiciens_de_la_ville_de_breme = ['un âne', 'la niche', 'le nuage', 'la fenêtre', 'la tulipe', 'une tomate', 'la route', 'une charette', 
'une branche', 'le vent', 'le champ', 'la tempête', 'la mèche', 'la tête', 'le peigne', 'le lait', 'le poulet', 'la caisse', 'quatre', 'le képi', 
'la cape', 'une casquette', 'le coq'];
